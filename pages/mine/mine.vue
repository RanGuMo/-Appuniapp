<template>
  <view class="template-about tn-safe-area-inset-bottom">
    ...
    <view class="top-backgroup">
      <image src='@/static/img/summer.jpg' mode='widthFix' class='backgroud-image'></image>
    </view>

    <view class="tnwave waveAnimation">
      <view class="waveWrapperInner bgTop">
        <view class="wave waveTop" style="background-image: url('../static/img/wave-2.png')"></view>
      </view>
      <view class="waveWrapperInner bgMiddle">
        <view class="wave waveMiddle" style="background-image: url('../static/img/wave-2.png')"></view>
      </view>
      <view class="waveWrapperInner bgBottom">
        <view class="wave waveBottom" style="background-image: url('../static/img/wave-1.png')"></view>
      </view>
    </view>
    ...
    <view class="about__wrap">
      ...
      <view class="user-info__container tn-flex tn-flex-direction-column tn-flex-col-center tn-flex-row-center">
        <view class="user-info__avatar tn-bg-grey--light tn-flex tn-flex-col-center tn-flex-row-center">
          <view class="tn-shadow-blur"
            style="background-image:url('../static/img/avatar_2.jpeg');width: 170rpx;height: 170rpx;background-size: cover;">
          </view>
          <!-- <view class="tn-icon-logo-tuniao" style="font-size: 140rpx;color: #01BEFF;"></view> -->
        </view>
        <view class="user-info__nick-name">
        {{userInfo?userInfo.username:'尚未登录'}}
        </view>
      </view>
      ...
      <view class="padding">
        <button class="cu-btn bg-red block">退出登录</button>

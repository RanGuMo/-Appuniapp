      ...
      <view class="login__wrapper">
        ...
        <view class="login__info tn-flex tn-flex-direction-column tn-flex-col-center tn-flex-row-center">
          ...
          <block v-if="currentModeIndex === 0">
            <view
              ...
              <view class="login__info__item__input__content">
                <input v-model="info.username" maxlength="20" placeholder-class="input-placeholder"
            ...
            <view
              ...
              <view class="login__info__item__input__content">
                <input v-model="info.password" :password="!showPassword" placeholder-class="input-placeholder"
                  placeholder="请输入登录密码" />
              </view>
          ...
          <view class="login__info__item__button tn-cool-bg-color-7--reverse" hover-class="tn-hover"
            :hover-stay-time="150" @click="handleLogin">{{ currentModeIndex === 0 ? '登录' : '注册'}}</view>
